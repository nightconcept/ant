...
class Shape {
    ...
    describe(): number { return this.id; }
    weight(): number { return this.area * 2; }
}

class Circle extends Shape {
    r: number;
    constructor(id: number, r: number) { super(id); this.r = r; this.area = r * r * 3; }
...
class Square extends Shape {
    s: number;
    constructor(id: number, s: number) { super(id); this.s = s; this.area = s * s; }
...
class Triangle extends Shape {
    b: number;
    h: number;
    constructor(id: number, b: number, h: number) { super(id); this.b = b; this.h = h; this.area = b * h / 2; }
...
class Rect extends Shape {
    w: number;
    h: number;
    constructor(id: number, w: number, h: number) { super(id); this.w = w; this.h = h; this.area = w * h; }
...
function runClassDispatch(count: number, passes: number): number {
